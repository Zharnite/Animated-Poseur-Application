...
export class UpdateListField_Transaction extends jsTPS_Transaction {
    ...
    doTransaction() {
        this.updateFunction({ variables: { _id: this._id, field: this.field, value: this.update } });
    }
    undoTransaction() {
        this.updateFunction({ variables: { _id: this._id, field: this.field, value: this.prev } });
    }
}

export class UpdateName_Transaction extends jsTPS_Transaction {
    constructor(prev, curr, callback) {
        super();
        this.previousName = prev;
        this.newName = curr;
        this.updateNameFunction = callback;
    }
    doTransaction() {
        this.updateNameFunction(this.newName);
    }
    undoTransaction() {
        this.updateNameFunction(this.previousName);
    }
}

export class UpdateOwner_Transaction extends jsTPS_Transaction {
    constructor(prev, curr, callback) {
        super();
        this.previousOwner = prev;
        this.newOwner = curr;
        this.updateOwnerFunction = callback;
    }
    doTransaction() {
        this.updateOwnerFunction(this.newOwner);
    }
    undoTransaction() {
        this.updateOwnerFunction(this.previousOwner);
    }
}
...
export class UpdateListItems_Transaction extends jsTPS_Transaction {
    constructor(prev, curr, callback) {
        super();
        this.previousListItems = prev;
        this.newListItems = curr;
        this.updateListItems = callback;
    }
    doTransaction() {
        this.updateListItems(this.newListItems);
    }
    undoTransaction() {
        this.updateListItems(this.previousListItems);
    }
    
}

// export class ChangeList_Transaction extends jsTPS_Transaction {
//     constructor(prev, curr, callback) {
//         super();
//         this.previousList = prev;
//         this.newList = curr;
//         this.changeListFunction = callback;
//     }
//     doTransaction() {
//         this.changeListFunction(this.newList);
//     }
//     undoTransaction() {
//         this.changeListFunction(this.previousList);
//     }
// }
// // I think add/delete should be broken into 2 diff transactions,
// export class AddToList_Transaction extends jsTPS_Transaction {
//     constructor(prev, curr, callback) {
//         super();
//         this.previousList = prev;
//         this.newList = curr;
...
// export class DeleteFromList_Transaction extends jsTPS_Transaction {
//     constructor(prev, curr, callback) {
//         super();
//         this.previousList = prev;
//         this.newList = curr;
...
export class UpdateItem_Transaction extends jsTPS_Transaction {
    constructor(prev, curr, itemIndex, callback) {
        super();
        this.previousItem = prev;
        this.newItem = curr;
        this.itemIndex = itemIndex;
        this.updateItemFunction = callback;
    }
    doTransaction() {
        this.updateItemFunction(this.newItem, this.itemIndex);
    }
    undoTransaction() {
        this.updateItemFunction(this.previousItem, this.itemIndex);
    }
}
